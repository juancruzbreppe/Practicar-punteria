...
function selecPais(){
    ...
    /* 30 SEGUNDOS */
    db.collection("users").where("pais", "==", pais).where("tipoJuego", "==", "30seg").where("navegador", "==", document.getElementById('tipoMedio').value).get().then((querySnapshot) => {
        seg30.innerHTML= '';
        querySnapshot.forEach((doc) => {
        cont30seg++;
        json30seg.push({jugador: `${doc.data().nombre}`,puntos:`${doc.data().puntuacionTotal}` });
      });
    ...
    /* 60 SEGUNDOS */
    db.collection("users").where("pais", "==", pais).where("tipoJuego", "==", "60seg").where("navegador", "==", document.getElementById('tipoMedio').value).get().then((querySnapshot) => {
        seg60.innerHTML= '';
      querySnapshot.forEach((doc) => {
        cont60seg++;
        json60seg.push({jugador: `${doc.data().nombre}`,puntos:`${doc.data().puntuacionTotal}` });
      });
    ...
    /* 20 CLICKS */
    db.collection("users").where("pais", "==", pais).where("tipoJuego", "==", "20clicks").where("navegador", "==", document.getElementById('tipoMedio').value).get().then((querySnapshot) => {
        clicks20.innerHTML= '';
      querySnapshot.forEach((doc) => {
        cont20clicks++;
        json20clicks.push({jugador: `${doc.data().nombre}`,time:`${doc.data().tiempo}` });
      });
      var tiempoArreglado;
    ...
    /* 50 CLICKS */
    db.collection("users").where("pais", "==", pais).where("tipoJuego", "==", "50clicks").where("navegador", "==", document.getElementById('tipoMedio').value).get().then((querySnapshot) => {
        clicks50.innerHTML= '';
      querySnapshot.forEach((doc) => {
          cont50clicks++;
          json50clicks.push({jugador:`${doc.data().nombre}`,time:`${doc.data().tiempo}` });
      });
      var tiempoArreglado;
    ...
    /* 100 CLICKS */
    db.collection("users").where("pais", "==", pais).where("tipoJuego", "==", "100clicks").where("navegador", "==", document.getElementById('tipoMedio').value).get().then((querySnapshot) => {
        clicks100.innerHTML= '';
      querySnapshot.forEach((doc) => {
        cont100clicks++;
        json100clicks.push({jugador: `${doc.data().nombre}`,time:`${doc.data().tiempo}` });
      });
      var tiempoArreglado;
